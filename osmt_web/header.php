...
<div class="w3-bar w3-green">
  <a href="hauptmenu.php" class="w3-bar-item w3-button">Hauptmenü</a>
  <a href="dateimenu.php" class="w3-bar-item w3-button">Datei</a>
  <a href="funktionenmenu.php" class="w3-bar-item w3-button">Funktionen</a>  
  <a href="mySQLmenu.php" class="w3-bar-item w3-button">MySQL</a>
  <a href="expertenmenu.php" class="w3-bar-item w3-button">Experten</a>
  <a href="hilfemenu.php" class="w3-bar-item w3-button">Hilfe</a>
  <a href="beenden.php" class="w3-bar-item w3-button">Abmelden</a>
</div>
