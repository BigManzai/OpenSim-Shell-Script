...
if(isset($_POST['send']))
{
    ...
    $username = 'user'; //hier wird der Benutzer eingetragen den Ihr zum Login in die Seite verwenden wollt.
    $password = 'passwd';//hier wird das Passwort eingetragen den Ihr zum Login in die Seite verwenden wollt.
...
{
    //weiterleiten
    header('Location: ostools.php'); // Weiterleitung solange bis session destroy oder abgelaufen.
